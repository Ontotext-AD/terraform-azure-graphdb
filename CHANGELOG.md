...
## 2.4.0
* `external-dns-records` module for managing Azure DNS zones (public or private) and creating DNS records (A, CNAME, MX, TXT, NS, SRV) with optional VNet links for private zones.
