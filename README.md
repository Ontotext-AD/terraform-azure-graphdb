...
| tls\_certificate\_password | TLS certificate password for password-protected certificates. Either tls\_certificate\_password or tls\_certificate\_path must be provided | `string` | n/a | yes |
